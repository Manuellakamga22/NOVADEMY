      ...
      <div style={S.dash}>
        ...
        <main style={S.main}>
          ...
          <div style={S.stats}>
            ...
            <div style={S.stat}>
              <div style={S.statLabel}>Avis laissés</div>
              <div style={S.statVal}>0</div>
            </div>
          </div>
          ...
          <div style={S.g2}>
            <div style={S.card}>
              ...
              <div style={S.searchRow}>
                <input style={S.input} placeholder="Rechercher un élève" />
                  ...
                  <table style={S.tbl}>
                    ...
                    <tbody>
                      {students.map((student) => (
                        <tr key={student.id}>
                          <td style={S.tblTd}>{student.nom}</td>
                          <td style={S.tblTd}>{student.level}</td>
                          <td style={S.tblTd}>{student.city}</td>
                          <td style={S.tblTd}>{student.requests}</td>
                          <td style={S.tblTd}>{student.status}</td>
                          <td style={S.tblTd}>
                            <div style={S.actionRow}>
                              <button style={{ ...S.btn, ...S.btnGhost }}>Voir</button>
                              <button style={{ ...S.btn, ...S.btnDanger }}>Désactiver</button>
                            </div>
                          </td>
                        </tr>
                      ))}
            ...
            <div style={S.card}>
              ...
              <div style={S.infoBox}>
                <div style={S.infoLabel}>Élèves actifs</div>
                <div style={S.infoValue}>0</div>
              </div>

              <div style={S.infoBox}>
                <div style={S.infoLabel}>Demandes d'essai en cours</div>
                <div style={S.infoValue}>0</div>
              </div>

              <div style={S.infoBox}>
                <div style={S.infoLabel}>Avis à modérer</div>
                <div style={S.infoValue}>0</div>
              </div>
