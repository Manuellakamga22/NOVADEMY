...
function Payment() {
  ...
  // temporaire avant vrai branchement backend depuis la formule acceptée
  const selectedFormula = useMemo(
    () => ({
      id: 1,
      title: "Suivi régulier",
      category: "engagement", // "pack" ou "engagement"
      duration: "3 mois",
      teacher: "Professeur",
  ...
  const amountToPayNow =
    selectedFormula.category === "pack"
      ? selectedFormula.totalAmount
      : selectedFormula.firstPayment;

  const paymentExplanation =
    selectedFormula.category === "pack"
      ? "Vous réglez ici la totalité du pack."
      : "Vous réglez ici le premier mois. Les mois suivants seront prélevés ensuite.";
    ...
    try {
      const response = await fetch("http://localhost:5000/api/payments", {
        ...
        body: JSON.stringify({
          ...
          formula_type: selectedFormula.category,
          amount_paid_now: amountToPayNow,
          total_formula_amount: selectedFormula.totalAmount,
      ...
      alert(data.message || "Paiement validé");
      ...
      <div style={S.dash}>
        ...
        <main style={S.main}>
          ...
          <div style={S.infoBanner}>
            si la formule est un pack, vous payez la totalité.
            Si la formule correspond à un engagement sur 3 mois, vous payez
            seulement le premier mois maintenant.
          </div>
            ...
            <div style={S.card}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={S.btnRow}>
                  ...
                  <a href="/chat" style={{ ...S.btn, ...S.btnGhost }}>
                    Retour au chat
                  </a>
                </div>
              </form>
            ...
            <div style={S.card}>
              ...
              <div style={S.summaryGrid}>
                <div style={S.summaryBox}>
                  ...
                  <div style={S.summaryValue}>{selectedFormula.title}</div>
                </div>

                <div style={S.summaryBox}>
                  <div style={S.summaryLabel}>Durée</div>
                  <div style={S.summaryValue}>{selectedFormula.duration}</div>
                </div>

                <div style={S.summaryBox}>
                  <div style={S.summaryLabel}>Professeur</div>
                  <div style={S.summaryValue}>{selectedFormula.teacher}</div>
                </div>

                <div style={S.summaryBox}>
                  <div style={S.summaryLabel}>Matière</div>
                  <div style={S.summaryValue}>{selectedFormula.subject}</div>
                </div>

                <div style={S.summaryBox}>
                  <div style={S.summaryLabel}>Type</div>
                ...
                <div style={S.summaryBox}>
                  ...
                  <div style={S.summaryValue}>{selectedFormula.totalAmount} €</div>
                </div>
              </div>
              ...
              {selectedFormula.category === "engagement" ? (
                <div style={{ ...S.helperText, marginTop: 12 }}>
                  Mois suivants prévus : {selectedFormula.monthlyAmount} € / mois.
                </div>
              ) : null}
            </div>
          </div>
