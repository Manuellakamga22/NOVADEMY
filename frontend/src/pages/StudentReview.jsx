      ...
      <div style={S.dash}>
        <aside style={S.sidebar}>
          ...
          <nav style={S.sbNav}>
            ...
            <a style={S.sbLinkActive} href="/student/review">
              ⭐ Avis
            </a>
          </nav>
          ...
          <div style={S.topBar}>
            <div>
              ...
              <div style={S.smallSub}>
                L’avis intervient après le déroulement du cours. Il sert à
                valoriser le professeur et à améliorer la qualité de la plateforme.
              </div>
            </div>
          </div>

          <div style={S.infoBanner}>
            L’avis se fait après une séance effectuée. Il ne remplace pas la
            validation de la formule ni le paiement : il vient après l’expérience de cours.
          </div>
          ...
          <div style={S.grid2}>
            <div style={S.card}>
              ...
              <div style={S.cardDesc}>
                Vérifiez le cours et le professeur avant de déposer votre avis.
              </div>

              <div style={S.summaryBox}>
                <div style={S.summaryLabel}>Professeur</div>
                <div style={S.summaryValue}>{course.teacher}</div>
              </div>

              <div style={S.summaryBox}>
                <div style={S.summaryLabel}>Matière</div>
                <div style={S.summaryValue}>{course.subject}</div>
              </div>

              <div style={S.summaryBox}>
                <div style={S.summaryLabel}>Formule</div>
                <div style={S.summaryValue}>{course.formula}</div>
              </div>

              <div style={S.summaryBox}>
                <div style={S.summaryLabel}>Dernière séance</div>
                <div style={S.summaryValue}>{course.lastSession}</div>
              </div>
            </div>
            ...
            <div style={S.card}>
              ...
              <div style={S.cardDesc}>
                Donnez une note globale sur votre expérience avec ce professeur.
              </div>
              ...
              <div style={S.starsRow}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    style={rating >= star ? S.starBtnActive : S.starBtn}
                  >
                    ★
                  </button>
                ))}
            ...
            <form onSubmit={handleSubmit}>
              <div style={S.field}>
                ...
                <textarea
                  ...
                  placeholder="Décrivez votre expérience, la pédagogie, la clarté des explications, l’organisation des cours, etc."
                  style={S.textarea}
                />
              </div>
              ...
              <div style={S.btnRow}>
                ...
                <a href="/student/courses" style={{ ...S.btn, ...S.btnGhost }}>
                  Retour aux cours
                </a>
              </div>
            </form>
