  ...
  👥 Classes collectives
        ...
        <main style={S.main}>
          <div style={S.pageHead}>
            <div style={S.pageTitle}>👋 Bienvenue dans votre espace professeur</div>
            <div style={S.pageSub}>
          ...
          <div style={S.g2}>
            <div style={S.card}>
              <div style={S.cardTitle}>
                👤 Mon profil
                <a href="/teacher/profile" style={S.cardAction}>
                  Modifier →
                </a>
              </div>
              <p style={S.cardDesc}>
              ...
              <div style={S.profileGrid}>
                {[["Ville", "—"], ["Niveau", "—"], ["Commission", "—"], ["Vérifié", "—"]].map(
                  ([lbl, val]) => (
  ...
  Proposer une formule
          ...
          <div style={S.g2}>
            <div style={S.card}>
              <div style={S.cardTitle}>
                📅 Mes disponibilités
                <a href="/teacher/planning" style={S.cardAction}>
                  Gérer →
                </a>
              </div>
              <p style={S.cardDesc}>
            ...
            <div style={S.card}>
              <div style={S.cardTitle}>
                ...
                <a href="/teacher/requests" style={S.cardAction}>
                  Voir →
                </a>
              </div>
              <p style={S.cardDesc}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 14 }}>
                {[
                  ...
                  <span key={lbl} style={{ ...S.pill, background: bg, color: col }}>
                    {lbl}
                  </span>
                ))}
              </div>
          ...
          <div style={S.g2}>
            <div style={S.card}>
              <div style={S.cardTitle}>
                🎓 Mes élèves
                <a href="/teacher/students" style={S.cardAction}>
                  Voir →
                </a>
              </div>
              <p style={S.cardDesc}>
          ...
          <div style={S.card}>
            <div style={S.cardTitle}>
              💳 Revenus
              <a href="/teacher/revenue" style={S.cardAction}>
                Consulter →
              </a>
            </div>
            <p style={S.cardDesc}>
