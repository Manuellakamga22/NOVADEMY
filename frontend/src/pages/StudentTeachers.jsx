      ...
      <div style={S.dash}>
        <aside style={S.sidebar}>
          ...
          <nav style={S.sbNav}>
            ...
            <a style={S.sbLinkActive} href="/student/teachers">
              👩‍🏫 Mes professeurs
            </a>
        ...
        <main style={S.main}>
          <div style={S.topBar}>
            <div>
              ...
              <div style={S.smallSub}>
                Retrouvez ici les professeurs avec qui vous avez un vrai suivi
                après validation de la formule et paiement.
              </div>
            </div>
          </div>
          ...
          <div style={S.stats}>
            <div style={S.statAccent}>
              ...
              <div style={S.statValW}>{teachers.length}</div>
            </div>

            <div style={S.stat}>
              <div style={S.statLabel}>Formules actives</div>
              <div style={S.statVal}>{teachers.length}</div>
            </div>
                ...
                {teachers.map((teacher) => (
                  <div key={teacher.id} style={S.teacherCard}>
                    ...
                    <div style={S.pillRow}>
                      ...
                      >
                        Prochain cours : {teacher.nextCourse}
                      </span>
                    </div>
