    ...
    <div style={page}>
      <div style={card}>
        ...
        <div style={header}>
          ...
          <h1 style={title}>Inscription Élève</h1>
          <p style={subtitle}>
            Créez votre compte pour trouver un professeur adapté à vos besoins
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" style={button}>Créer mon compte élève</button>
        </form>
