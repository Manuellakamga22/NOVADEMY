    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", backgroundColor: "#F5F7FF", minHeight: "100vh", color: "#111827" }}>
      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #E5E7EB", padding: "0 48px", height: 68, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: 24 }}>
          {["Nos formules","Aide"].map(l => (
            <a key={l} href="#" style={{ fontSize: 16, fontWeight: 500, color: "#4B5563", textDecoration: "none" }}>{l}</a>
          ))}
          <a href="/login" style={{ fontSize: 16, fontWeight: 500, color: "#4B5563", textDecoration: "none" }}>Connexion</a>
          <a href="/register" style={{ fontSize: 16, fontWeight: 600, background: "#2563EB", color: "#fff", padding: "11px 20px", borderRadius: 8, textDecoration: "none" }}>Inscription</a>
        </nav>
      </header>
      ...
      <div style={{ background: "linear-gradient(135deg, #EFF6FF 0%, #F5F7FF 60%)", padding: "80px 64px", borderBottom: "1px solid #E5E7EB" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#EFF6FF", border: "1px solid #BFDBFE", color: "#2563EB", fontSize: 13, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", padding: "6px 16px", borderRadius: 30, marginBottom: 22 }}>
