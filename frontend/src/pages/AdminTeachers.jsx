      ...
      <div style={S.dash}>
        <aside style={S.sidebar}>
          ...
          <nav style={S.sbNav}>
            ...
            <a style={S.sbLinkActive} href="/admin/teachers">👩‍🏫 Professeurs</a>
        ...
        <main style={S.main}>
          ...
          <div style={S.stats}>
            ...
            <div style={S.stat}>
              <div style={S.statLabel}>Profils validés</div>
            ...
            <div style={S.stat}>
              <div style={S.statLabel}>Suspendus</div>
              <div style={S.statVal}>0</div>
            </div>
          </div>
          ...
          <div style={S.g2}>
            <div style={S.card}>
              ...
              <div style={S.searchRow}>
                <input style={S.input} placeholder="Rechercher un professeur" />
                  ...
                  <table style={S.tbl}>
                    ...
                    <tbody>
                      {teachers.map((teacher) => (
                        <tr key={teacher.id}>
                          <td style={S.tblTd}>{teacher.nom}</td>
                          <td style={S.tblTd}>{teacher.subject}</td>
                          <td style={S.tblTd}>{teacher.level}</td>
                          <td style={S.tblTd}>{teacher.hours} h</td>
                          <td style={S.tblTd}>{teacher.commission}%</td>
                          <td style={S.tblTd}>{teacher.status}</td>
                          <td style={S.tblTd}>
                            <div style={S.actionRow}>
                              <button style={{ ...S.btn, ...S.btnSuccess }}>Valider</button>
            ...
            <div style={S.card}>
              ...
              <div style={S.infoBox}>
                <div style={S.infoLabel}>Profils à valider</div>
                <div style={S.infoValue}>0</div>
              </div>

              <div style={S.infoBox}>
                <div style={S.infoLabel}>Professeurs suspendus</div>
                <div style={S.infoValue}>0</div>
              </div>

              <div style={S.infoBox}>
                <div style={S.infoLabel}>Annonces à vérifier</div>
                <div style={S.infoValue}>0</div>
              </div>
