        ...
        <main style={S.main}>
          ...
          <div style={S.stats}>
            ...
            <div style={S.stat}>
              ...
              <div style={S.statVal}>
                {requests.filter((r) => r.status === "acceptee").length}
              </div>
            </div>
            ...
            <div style={S.stat}>
              ...
              <div style={S.statVal}>
                {requests.filter((r) => r.status === "reportee").length}
              </div>
            </div>
          </div>
          ...
          <div style={S.card}>
            ...
            <p style={S.cardDesc}>
              Ici, le professeur consulte la fiche synthétique de la demande :
              annonce choisie, créneau demandé et besoin pédagogique de l’élève.
            </p>
                ...
                {requests.map((request) => (
                  <div key={request.id} style={S.requestCard}>
                    <div style={S.requestHeader}>
                      <div>
                        <h4 style={S.requestTitle}>{request.student_prenom || ''} {request.student_nom || ''}</h4>
                        <p style={S.requestSub}>{request.title}</p>
                      </div>
                    ...
                    <div style={S.infoGrid}>
                      <div style={S.infoBox}>
                        ...
                        <div style={S.infoValue}>{request.subject}</div>
                      </div>

                      <div style={S.infoBox}>
                        <div style={S.infoLabel}>Créneau demandé</div>
                        <div style={S.infoValue}>{request.requestedSlot}</div>
                      </div>
                    </div>

                    <div style={S.messageBox}>
                      <div style={S.infoLabel}>Besoin de l’élève</div>
                      <p style={S.messageText}>{request.message}</p>
                    </div>

                    <div style={S.actionsRow}>
                      <button
                        style={{ ...S.btn, ...S.btnAccept }}
                        onClick={() => updateStatus(request.id, "acceptee")}
                      >
                        Accepter
                      </button>
                      ...
                      <button
                        ...
                        onClick={() => updateStatus(request.id, "reportee")}
                      >
                        Reporter
                      </button>
                      ...
                      <button
                        ...
                        onClick={() => updateStatus(request.id, "refusee")}
                      >
                        Refuser
                      </button>
                    </div>
